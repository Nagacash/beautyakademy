  ...
  return (
    <div className="relative bg-[#050505]">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-8 flex justify-between items-center mix-blend-difference">
        ...
        <span className="text-[10px] tracking-[0.4em] text-white uppercase font-black">History & Vision</span>
      </nav>
      ...
      <section className="relative z-20 bg-[#050505] py-48 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          ...
          >
            <h4 className="text-[#E2C3B1] font-bold tracking-[0.5em] text-[10px] uppercase">GEMEINSAME EXPERTISE</h4>
      ...
      {/* Philosophy Section */}
      <section className="relative z-20 bg-[#080808] py-48 px-6 lg:px-24 border-y border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div
                ...
                className="p-12 bg-white/[0.02] border border-white/5 rounded-3xl"
              >
                <p className="text-[10px] tracking-[0.4em] text-[#E2C3B1] uppercase mb-4">{stat.label}</p>
      ...
      {/* Core Narrative */}
      <section id="modules" className="relative z-20 bg-[#050505] py-48 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="mb-24">
            <h4 className="text-[#E2C3B1] font-bold tracking-[0.5em] text-[10px] uppercase mb-8">Was uns antreibt</h4>
            <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white uppercase leading-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="group p-12 bg-white/[0.01] hover:bg-white/[0.03] border border-white/5 transition-all duration-500 rounded-[30px]"
              >
                <h5 className="text-white font-bold uppercase tracking-tight text-xl mb-6 group-hover:text-[#E2C3B1] transition-colors">{item.title}</h5>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center bg-[#050505] z-30 overflow-hidden py-32">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#E2C3B1]/[0.04] rounded-full blur-[120px] pointer-events-none" />
        <motion.div
        ...
        >
          <h2 className="text-4xl md:text-8xl font-black tracking-tighter mb-16 uppercase leading-none">Werde Teil <br /> der Elite.</h2>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            <button className="px-16 py-6 btn-premium text-[#050505] font-black uppercase text-[10px] tracking-[0.3em] rounded-full shadow-2xl">
              Mentorship Anfragen
            </button>
            <button className="px-16 py-6 border border-white/20 text-white font-black uppercase text-[10px] tracking-[0.3em] rounded-full hover:bg-white/5 transition-all">
              WhatsApp Kontakt
            </button>
          </div>
        </motion.div>
