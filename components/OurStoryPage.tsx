          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4 relative z-10">
              ...
              <motion.div
                ...
                className="aspect-[3/4] rounded-[30px] md:rounded-[40px] overflow-hidden border border-white/5 group"
              >
                <img src="/images/team/team7.webp" className="w-full h-full object-cover grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000" alt="Team" />
                <div className="absolute inset-0 bg-gradient-to-tr from-[#050505] via-transparent to-transparent" />
              </motion.div>
            </div>
          </div>
