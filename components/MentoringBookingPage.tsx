...
const MentoringBookingPage: React.FC<MentoringBookingPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="relative min-h-[500vh] bg-[#050505]">
            ...
            <div className="space-y-3 mb-12 max-h-[450px] overflow-y-auto pr-4 custom-scrollbar relative z-10">
              {modules.map(module => (
                <button
                  ...
                  className={`group w-full flex justify-between items-center p-5 rounded-2xl border transition-all duration-500 ${
