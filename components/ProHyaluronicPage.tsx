...
import { HYALURONIC_BEATS, getFrameUrl } from '../constants';

interface ProHyaluronicPageProps {
  onBack: () => void;
}
  ...
  return (
    <div className="relative min-h-[400vh] bg-[#050505]">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-8 flex justify-between items-center mix-blend-difference">
        ...
        <span className="text-[10px] tracking-[0.4em] text-white uppercase font-black">Modul 03</span>
      </nav>
      ...
      <section className="relative z-20 bg-[#050505] py-48 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <h4 style={{ color: accentColor }} className="text-[10px] font-bold tracking-[0.5em] uppercase">Wissenschaft & Ästhetik</h4>
              <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white uppercase leading-none italic">
                Mehr als nur <br /> Filler.
              </h2>
              <p className="text-white/40 text-xl font-light leading-relaxed mb-8 italic">
                Das Pro Hyaluronic Modul konzentriert sich auf die Biokompatibilität vernetzter Ketten und deren Interaktion mit der extrazellulären Matrix.
              </p>
              <ul className="space-y-6">
                {['Meso-Layer Integration', 'Rheologie Selektion', 'Vektorisierte Stützkraft', 'Matrix Regeneration'].map(item => (
            ...
            >
              ...
              <div className="text-center z-10 p-12">
                <h4 style={{ color: accentColor }} className="text-sm font-bold tracking-[0.5em] uppercase mb-8 opacity-40">Modul Fokus</h4>
                <p className="text-white text-7xl md:text-9xl font-black tracking-tighter italic leading-none">98.4%</p>
                <p className="text-white/40 text-xs tracking-widest uppercase mt-8 italic font-bold">Biokompatibilität Rate</p>
              </div>
            </motion.div>
          </div>
        </div>
...
export default ProHyaluronicPage;