...
const OverlayText: React.FC<OverlayTextProps> = ({ beat, scrollProgress, theme = 'light' }) => {
  ...
  return (
    ...
    >
      <motion.h2 
        className={`font-black tracking-tighter leading-[0.9] mb-8 md:mb-12 uppercase transition-colors duration-1000 text-5xl sm:text-7xl md:text-8xl lg:text-[10rem] xl:text-[12rem] ${titleColor}`}
        style={{ 
