...
import { MITOCHONDRIEN_BEATS, getFrameUrl } from '../constants';

interface MitochondrienPageProps {
  onBack: () => void;
}

const MitochondrienPage: React.FC<MitochondrienPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="relative min-h-[400vh] bg-[#050505]">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-8 flex justify-between items-center mix-blend-difference">
        ...
        <span className="text-[10px] tracking-[0.4em] text-white uppercase font-black">Modul 01</span>
      </nav>
      ...
      <div className="relative h-[400vh] z-10">
        ...
        <div className="sticky top-0 h-screen w-full pointer-events-none overflow-hidden">
          ...
          >
            <span style={{ color: accentColor }} className="text-[10px] tracking-[0.5em] uppercase mb-4 font-bold opacity-60">Der Motor des Lebens</span>
            <motion.div 
              animate={{ y: [0, 10, 0] }}
      ...
      <section className="relative z-20 bg-[#050505] py-48 px-6 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <h4 style={{ color: accentColor }} className="text-[10px] font-bold tracking-[0.5em] uppercase">Molekulare Präzision</h4>
              <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-white uppercase leading-none italic">
                Bio-Energy <br /> Mastery.
              </h2>
              <p className="text-white/40 text-xl font-light leading-relaxed mb-8 italic">
                Mitochondrien sind mehr als nur Kraftwerke; sie sind die Regulatoren des zellulären Schicksals. In Modul 01 vertiefen wir die Symbiose zwischen Gesundheit und Langlebigkeit.
              </p>
              <ul className="space-y-6">
                {['Mitochondriale Biogenese', 'ATP-Währungs Optimierung', 'Antioxidative Synergie', 'Genetische Expressionskontrolle'].map(item => (
            ...
            >
              ...
              <div className="text-center z-10 p-12">
                <h4 style={{ color: accentColor }} className="text-sm font-bold tracking-[0.5em] uppercase mb-8 opacity-40">Zellulärer Output</h4>
                <p className="text-white text-7xl md:text-9xl font-black tracking-tighter italic leading-none">+320%</p>
                <p className="text-white/40 text-xs tracking-widest uppercase mt-8 italic font-bold">ATP Effizienz Steigerung</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center bg-[#050505] z-30 overflow-hidden py-32">
        ...
        >
          <h4 style={{ color: accentColor }} className="text-[12px] font-bold tracking-[0.6em] uppercase mb-12">Aktiviere den Kern</h4>
          <h2 className="text-5xl md:text-[10rem] font-black tracking-tighter mb-16 uppercase leading-[0.7] italic text-white">ACTIVATE <br/> THE CORE.</h2>
          <button className="px-20 py-8 btn-premium text-[14px] uppercase tracking-[0.4em] rounded-full">
            JETZT FÜR MODUL 01 ANMELDEN
          </button>
        </motion.div>
      </section>
    </div>
...
export default MitochondrienPage;